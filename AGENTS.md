...
Gameplay QA routing: routine live-editor checks → `.agents/skills/godot-gameplay-qa/SKILL.md`; exported Windows `.exe` black-box checks → `.agents/skills/windows-export-playtest/SKILL.md`.
